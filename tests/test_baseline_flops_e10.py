...
def test_e10_baseline_training_flops_under_1e10() -> None:
    """e10.yaml baseline should train under 1e10 FLOPs.
    ...
    cfg_path = repo_root / "src/chess_engine_2/baselines/e10.yaml"
    ...
    assert (
        total_training_flops < 10_000_000_000
    ), f"Total FLOPs {total_training_flops:,} exceeds 1e10 for e10.yaml"
